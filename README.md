...
- `OUTBOUND_AUDIT_LOG_PATH` appends unified outbound audit events for provider HTTP calls and file-based dependencies without storing sensitive request bodies or credentials.
